import { animeList, type AnimeEntry } from '../data/anime'

function AnimePanelRow({
  anime,
  index,
  total,
}: {
      ...
      {bgImage ? (
        ...
        <div
          ...
          style={{
            position: 'absolute',
            inset: 0,
            background: `radial-gradient(ellipse at 60% 40%, ${anime.themeColor}55 0%, #050a0e 65%)`,
          }}
        />
      )}
      ...
      >
        ...
        <h2
          style={{
            ...
            color: '#FFFFFF',
            textShadow: `0 0 60px ${anime.themeColor}70, 0 2px 10px rgba(0,0,0,0.9)`,
          }}
        >
          {anime.title}
        </h2>
